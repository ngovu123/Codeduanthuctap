...
public class PhanBo {
    ...
    public PhanBo(int maPB, int maTS, int maND, int maNTS, int maLTS, int maP, int soLuong, String ghiChu, String tenTS, String tenLTS, String tenNTS, String tenP, String ngayCapNhat, String ngayTao) {
        MaPB = maPB;
        MaTS = maTS;
        MaND = maND;
        MaNTS = maNTS;
