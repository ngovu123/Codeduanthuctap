package com.example.baohongtaisantdmu_admin.Adapter.NguoiDung;
...
public class AdminChucDanhAdapter extends RecyclerView.Adapter<AdminChucDanhAdapter.ChucdanhViewHolder> {
    ...
    public ChucdanhViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_rcv_chucdanh_admin, parent, false);
    ...
    public void searchDataList(List<ChucDanh> searchlist) {
