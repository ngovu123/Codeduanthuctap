...
public class TaiSan {
    ...
    public TaiSan(int maTS, int maNTS, int maLTS, String tenTS, String hinhAnh, String ghiChu, String hangSanXuat, String ngayCapNhat, String ngayTao, int giaTri, int SLNhapVao, int SLHienCon, int phamChat, int namSanXuat, String tenLTS, String tenNTS) {
        MaTS = maTS;
        MaNTS = maNTS;
        MaLTS = maLTS;
        TenTS = tenTS;
