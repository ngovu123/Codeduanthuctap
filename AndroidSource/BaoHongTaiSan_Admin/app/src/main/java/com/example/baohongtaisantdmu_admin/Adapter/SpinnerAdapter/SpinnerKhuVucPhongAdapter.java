...
public class SpinnerKhuVucPhongAdapter extends ArrayAdapter<KhuVucPhong> {

    public SpinnerKhuVucPhongAdapter(@NonNull Context context, int resource, List<KhuVucPhong> khuVucPhongList) {
